...
export const ResizableNavbar = ({
  ...
  return (
    <motion.div
      ref={ref}
      className={cn("fixed inset-x-0 top-5 px-8 z-100 w-full", className)}
    >
...
export const NavbarCustomLogo = ({ img }: { img: string }) => {
  return (
    <a
      href="#"
      className="relative z-20 mr-4 flex items-center space-x-2 px-2 py-1 text-sm font-normal text-black"
...
export const NavbarAvatar = ({ img }: NavbarAvatarProps) => {
  return (
    <Avatar>
      <AvatarImage src={img} />
      <AvatarFallback>
